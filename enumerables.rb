...
def spiciest_foods(spicy_foods)
  spicier_than_five = spicy_foods.filter { |food| food[:heat_level] > 5}
end
...
def average_heat_level(spicy_foods)
  total_spice_level = spicy_foods.sum { |food| food[:heat_level]}
  average = total_spice_level / spicy_foods.length
end
